...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="assets/images/llogo2.png" type="image/png"/>
        <title>Login Rancak Laundry</title>
    ...
    <style>
        .accountbg {
            background-image: url('assets/images/bglaundry2.png');
            ...
            <div class="card">
                <div class="card-body">
                    <h3 class="text-center mt-0 m-b-15">
                        <a href="login.php"><img src="assets/images/llogo2.png" width="200px"></a>
                    </h3>

                    <div class="p-3">
                        <h4 class="text-center mt-0 m-b-15">Login Rancak Laundry</h4>
